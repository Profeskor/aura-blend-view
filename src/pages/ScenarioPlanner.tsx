...
import InsightsChatbot, { type InsightsChatbotHandle } from "@/components/InsightsChatbot";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-[1400px] px-6 py-8">
        ...
        >
          <button
            onClick={() => chatRef.current?.openWithPrompt("Generate a comprehensive insight summary of this scenario. Cover key risks, opportunities, seasonal patterns, and actionable recommendations.")}
